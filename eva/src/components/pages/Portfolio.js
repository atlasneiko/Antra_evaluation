                ...
                <div className="row">
                  <div className="col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4">
                    <div className="project-more-info">
                      <Link to={location}><p className="btn btn-default btn-border">More</p></Link>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="strike-zone-project">
                ...
                <div className="row">
                  <div className="col-sm-4 col-md-4 col-sm-offset-4 col-md-offset-4">
                    <div className="project-more-info">
                      <Link to={location}>
                        <p className="btn btn-default btn-border">More</p>
                      </Link>
                    </div>
                  </div>
                </div>
          ...
          <div className="row">
            <div className="col-sm-2 col-md-2 col-sm-offset-5 col-md-offset-5">
              <div className="see-more-button">
                <Link to={location}>
                  <p className="btn btn-default btn-border">More projects</p>
                </Link>
              </div>
            </div>
          </div>
