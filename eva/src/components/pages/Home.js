...
const Home = () => {
  const [about, setAbout] = useState({ aboutMe: "", generalOverview: "", statistics: "" });
  useEffect(() => {
    getData().then(res => {
      setAbout(res);
    })
              ...
              <div className="development-summary">
                <div className="col-sm-1 col-md-1">
                  <div className="development-img">
                    <img className="img-responsive" src="./images/developerdesign.svg" alt="dev-design" />
                  </div>
                </div>
              ...
              <div className="responsive-summary">
                <div className="col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2">
                  <div className="responsive-img">
                    <img className="img-responsive" src="./images/responsivedesign.svg" alt="summary-img" />
                  </div>
                </div>
              ...
              <div className="ideas-summary">
                <div className="col-sm-1 col-md-1">
                  <div className="idea-img">
                    <img className="img-responsive" src="./images/innovativesolutions.svg" alt="idea summary" />
                  </div>
                </div>
